      ...
      >
        ...
        <ul className="pt-2">
          {Menus.map((menu, index)=>(
            <Link to={`/${menu.title}`} key={index} className="text-white text-l flex items-center gap-x-4 cursor-pointer  hover:bg-white hover:text-black rounded-full p-3 mt-1">
        ...
        <ul className="pt-3 absolute bottom-10 left-0 border-t-4 w-full">
            <li className="text-white text-l flex items-center gap-x-4 cursor-pointer  hover:bg-white hover:text-black rounded-full p-3 mt-1">
                ...
                <span className={`text-base font-medium flex-1 duration-200 ${!open && "hidden"}`}>Setting</span>
